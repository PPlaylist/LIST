class AES:
    rcon = ([0x8d,0,0,0],[0x01,0,0,0],[0x02,0,0,0],[0x04,0,0,0],[0x08,0,0,0],[0x10,0,0,0],
    ...
    def _expand_key(self, key):
        ...
        for round_n in range(self._round):
            ...
            round_key = self._xor(self._xor(round_key, prev_round_key[:4]), self.rcon[round_n+1])
    ...
    def _sub_bytes_inv(self):
        self._state = [ self.sbox.index(c) for c in self._state]
...
if __name__ == '__main__':
    ...
    for t in range(test):
        ...
        assert plain == aes.decrypt(cipher)
